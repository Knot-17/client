...
import { AwardWinnersContainer, ButtonContainer,DistanceForm, ClearButton, DistanceContainer, DropdownContainer, MoreFiltersContainer, SaveButton, StartingPriceContainer, StartPriceForm,WeddingEventsContainer, MoreFilters, CloseIcon, MoreFiltersWrapper, MoreFiltersH1, DecoAccentsContainer, DecoAccentsForm, LightingContainer } from './FilterElements';
...
const Filter = () => {
    ...
    return (
        ...
        <div>
            ...
            <DecoAccentsContainer ref={DecoAccentsRef} 
            onClick={() => {
            ...
            <LightingContainer ref={LightingRef} 
            onClick={() => {
...
<DropdownContainer className={`${showDecoAccents? "block":"hidden"} ml-[16.5%] `} ref={DADropRef} >
            <DecoAccentsForm  >
  ...
  <FormGroup 
    ...
    name="radio-buttons-group"
  >
    <FormControlLabel value="Aisle Decorations"  control={<Checkbox />} label="Aisle Decorations" />
    <FormControlLabel value="Backdrops"  control={<Checkbox />} label="Backdrops" />
    <FormControlLabel value="Candles"  control={<Checkbox />} label="Candles" />
    <FormControlLabel value="Centerpieces" control={<Checkbox />} label="Centerpieces" />
    <FormControlLabel value="Ceremony Accessories"  control={<Checkbox />} label="Ceremony Accessories" />
    <FormControlLabel value="Design"  control={<Checkbox />} label="Design" />
    <FormControlLabel value="Flower Girl Baskets"  control={<Checkbox />} label="Flower Girl Baskets" />
    <FormControlLabel value="Pendestals"  control={<Checkbox />} label="Pendestals" />
    <FormControlLabel value="Plants"  control={<Checkbox />} label="Plants" />
    <FormControlLabel value="Ring Pillows"  control={<Checkbox />} label="Ring Pillows" />
    <FormControlLabel value="Signs"  control={<Checkbox />} label="Signs" />
    <FormControlLabel value="Theme Props"  control={<Checkbox />} label="Theme Props" />
    <FormControlLabel value="Unity Ceremony Supplies"  control={<Checkbox />} label="Unity Ceremony Supplies" />
    <FormControlLabel value="Vases"  control={<Checkbox />} label="Vases" />
    <FormControlLabel value="Wedding Arch"  control={<Checkbox />} label="Wedding Arch" />
    <FormControlLabel value="Wedding Decoration Delivery"  control={<Checkbox />} label="Wedding Decoration Delivery" />
    <FormControlLabel value="Wedding Decoration Setup"  control={<Checkbox />} label="Wedding Decoration Setup" />
    <FormControlLabel value="Wedding Designers"  control={<Checkbox />} label="Wedding Designers" />
  </FormGroup >
...
<DropdownContainer className={`${showLighting? "block":"hidden"} ml-[27.5%] `} ref={LDropRef} >
            <DecoAccentsForm  >
  ...
  <FormGroup 
    ...
    name="radio-buttons-group"
  >
    <FormControlLabel value="Candelabars"   control={<Checkbox />} label="Candelabars" />
    <FormControlLabel value="Chandeliers"   control={<Checkbox />} label="Chandeliers" />
    <FormControlLabel value="Lanterns"  control={<Checkbox />} label="Lanterns" />
    <FormControlLabel value="Lighting Design & Setup"  control={<Checkbox />} label="Lighting Design & Setup" />
    <FormControlLabel value="Sting Lights"  control={<Checkbox />} label="Sting Lights" />
    <FormControlLabel value="Uplighting"  control={<Checkbox />} label="Uplighting" />
