...
import { CategoryWrapper,CategoryContainer, ArrowDown, ArrowUp,DropDownContainerL , CameraIcon, GuitarIcon, PlaneIcon, FlowerIcon, SpoonIcon,CloseIcon, DropDownContainer, LocationWrapper,LocationContainer, SearchIcon, SearchButton, LipstickIcon  } from './DecoratorsElements';
            ...
            >
                ...
                >
                    ...
                    <div className='flex mt-[2px] text-[12px] md:text-[16px]' >
                       {selectedItemIndex !== null ? itemsList[selectedItemIndex].name : "Decorators"}
