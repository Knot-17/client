...
const Filter = () => {
    ...
    return (
        ...
        <div>
            ...
            <BeauServicesContainer ref={BeauServicesRef} 
            onClick={() => {
            ...
            <FitnessServicesContainer ref={FitnessServicesRef} 
            onClick={() => {
...
<DropdownContainer className={`${showBeauServices? "block":"hidden"} ml-[16.5%] `} ref={BSDropRef} >
            <BeutyServicesForm  >
  ...
  <FormGroup 
    ...
    name="radio-buttons-group"
  >
    <FormControlLabel value="Beauty Group Bookings"  control={<Checkbox />} label="Beauty Group Bookings" />
    <FormControlLabel value="Hair Stylists"  control={<Checkbox />} label="Hair Stylists" />
    <FormControlLabel value="Hair Trials Available"  control={<Checkbox />} label="Hair Trials Available" />
    <FormControlLabel value="Makeup"  control={<Checkbox />} label="Makeup" />
    <FormControlLabel value="Makeup Artists"  control={<Checkbox />} label="Makeup Artists" />
    <FormControlLabel value="Makeup Trials Available"  control={<Checkbox />} label="Makeup Trials Available" />
    <FormControlLabel value="Nails"  control={<Checkbox />} label="Nails" />
    <FormControlLabel value="On-Site Hair & Makeup"  control={<Checkbox />} label="On-Site Hair & Makeup" />
    <FormControlLabel value="Spas"  control={<Checkbox />} label="Spas" />
    <FormControlLabel value="Tanning"  control={<Checkbox />} label="Tanning" />
    <FormControlLabel value="Teeth Whitening"  control={<Checkbox />} label="Teeth Whitening" />
...
<DropdownContainer className={`${showFitnessServices? "block":"hidden"} ml-[27.5%] `} ref={FSDropRef} >
            <FitnessServicesForm  >
  ...
  <FormGroup 
    ...
    name="radio-buttons-group"
  >
    <FormControlLabel value="Boot Camps"  control={<Checkbox />} label="Boot Camps" />
    <FormControlLabel value="Diet & Nutrition"  control={<Checkbox />} label="Diet & Nutrition" />
    <FormControlLabel value="Fitness Videos"  control={<Checkbox />} label="Fitness Videos" />
    <FormControlLabel value="Gyms"  control={<Checkbox />} label="Gyms" />
    <FormControlLabel value="Personal Trainers"  control={<Checkbox />} label="Personal Trainers" />
