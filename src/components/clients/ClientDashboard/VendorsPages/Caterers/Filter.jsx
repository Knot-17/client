...
import { ButtonContainer,DistanceForm, ClearButton, DistanceContainer, DropdownContainer, MoreFiltersContainer, SaveButton, MoreFilters, CloseIcon, MoreFiltersWrapper, MoreFiltersH1,FoodCateringContainer, CuisineContainer, FoodCateringForm, CuisineForm } from './FilterElements';
...
const Filter = () => {
    ...
    return (
        ...
        <div>
            ...
            <FoodCateringContainer ref={FoodCaterinfRef} 
            onClick={() => {
            ...
            <CuisineContainer ref={CuisineRef} 
            onClick={() => {
...
<DropdownContainer className={`${showFoodCatering? "block":"hidden"} ml-[16.5%] `} ref={FCDropRef} >
            <FoodCateringForm  >
  ...
  <FormGroup 
    ...
    name="radio-buttons-group"
  >
    <FormControlLabel value="Buffet"  control={<Checkbox />} label="Buffet" />
    <FormControlLabel value="Catering Clean Up"  control={<Checkbox />} label="Catering Clean Up" />
    <FormControlLabel value="Catering Delivery & Setup"  control={<Checkbox />} label="Catering Delivery & Setup" />
    <FormControlLabel value="Chef Stations"  control={<Checkbox />} label="Chef Stations" />
    <FormControlLabel value="Family Style"  control={<Checkbox />} label="Family Style" />
    <FormControlLabel value="Food Trucks"  control={<Checkbox />} label="Food Trucks" />
    <FormControlLabel value="Menu Tastings"  control={<Checkbox />} label="Menu Tastings" />
    <FormControlLabel value="Passed Appetizers"  control={<Checkbox />} label="Passed Appetizers" />
    <FormControlLabel value="Seated Meal"  control={<Checkbox />} label="Seated Meal" />
    <FormControlLabel value="Servers"  control={<Checkbox />} label="Servers" />
...
<DropdownContainer className={`${showCuisine? "block":"hidden"} ml-[27.5%] `} ref={CDropRef} >
            <CuisineForm  >
  ...
  >
    ...
    <FormControlLabel value="African"  control={<Checkbox />} label="African" />
    <FormControlLabel value="BBQ"  control={<Checkbox />} label="BBQ" />
    <FormControlLabel value="Cajun"  control={<Checkbox />} label="Cajun" />
    <FormControlLabel value="Chinese"  control={<Checkbox />} label="Chinese" />
    <FormControlLabel value="Eastern European"  control={<Checkbox />} label="Eastern European" />
    <FormControlLabel value="French"  control={<Checkbox />} label="French" />
    <FormControlLabel value="Fusion"  control={<Checkbox />} label="Fusion" />
    <FormControlLabel value="Greek"  control={<Checkbox />} label="Greek" />
    <FormControlLabel value="Hawaiian"  control={<Checkbox />} label="Hawaiian" />
    <FormControlLabel value="Indian"  control={<Checkbox />} label="Indian" />
    <FormControlLabel value="Italian"  control={<Checkbox />} label="Italian" />
    ...
    <FormControlLabel value="Latin American"  control={<Checkbox />} label="Latin American" />
    <FormControlLabel value="Mexican"  control={<Checkbox />} label="Mexican" />
    <FormControlLabel value="Middle Eastern"  control={<Checkbox />} label="Middle Eastern" />
    <FormControlLabel value="Seafood"  control={<Checkbox />} label="Seafood" />
    <FormControlLabel value="Southern"  control={<Checkbox />} label="Southern" />
    <FormControlLabel value="Southwestern"  control={<Checkbox />} label="Southwestern" />
    <FormControlLabel value="Specialty"  control={<Checkbox />} label="Specialty" />
    <FormControlLabel value="Thai"  control={<Checkbox />} label="Thai" />
...
<MoreFilters className={`${showMoreFilters? "block":"hidden"} `} ref={MfDropRef} >
 ...
 <FormGroup  className='ml-[30px]'>
     ...
     <table className=' w-[350px]'>
      <tbody>
      <tr >
        <td ><FormControlLabel value="Dairy Free"   control={<Checkbox />} label="Dairy Free" /></td>
        <td ><FormControlLabel value="Organic"   control={<Checkbox />} label="Organic" /></td>
      </tr>
      <tr>
        <td><FormControlLabel value="Gluten Free"   control={<Checkbox />} label="Gluten Free" /></td>
        <td><FormControlLabel value="Sugar Free"   control={<Checkbox />} label="Sugar Free" /></td>
      </tr>
      <tr>
        <td><FormControlLabel value="Halal"   control={<Checkbox />} label="Halal" /></td>
        <td><FormControlLabel value="Vegan"   control={<Checkbox />} label="Vegan" /></td>
        
      </tr>
      <tr>
        <td><FormControlLabel value="Kosher"   control={<Checkbox />} label="Kosher" /></td>
        <td><FormControlLabel value="Vegetarian"   control={<Checkbox />} label="Vegetarian" /></td>
        
      </tr>
      <tr>
        <td><FormControlLabel value="Nut Free"   control={<Checkbox />} label="Nut Free" /></td>
