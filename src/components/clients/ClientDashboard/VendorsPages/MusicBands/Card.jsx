...
const Cardss = ( {AvailableArea,VendorPic}) => {
        ...
        <div className='w-full'>
          ...
          <div className={`fixed pt-[100px] z-[1] left-0 top-0 overflow-auto w-full h-full
           bg-black/40  justify-center items-center ${showReqQuote===true? 'flex': 'hidden'}`}>
            ...
            <h1 className=' text-[12px] font-[500]'>{step +1} of 11 - {DisplaySteps()}</h1>
            <div className=' w-full  h-[8px] rounded '>
            {/*progress bar */}
            
            <div  className={` h-[100%] bg-green-700 rounded
            ${step === 0 ? "w-[9%]" : step === 1 ? "w-[18%]" : step === 2 ? "w-[27%]" : step === 3 ? "w-[36%]" :
             step === 4 ? "w-[45%]" : step === 5 ? "w-[54%]" : step === 6? "w-[63%]" : step === 7? "w-[72%]" : step === 8? "w-[81%]" : step === 9? "w-[90%]" : step === 10? "w-[100%]"  : ""}
            } `}>
            </div>
          </div>
    ...
    <div className={`border-[1px] border-slate-300 w-full flex justify-center ${city===true? 'block': 'hidden'} `}>
         ...
         <div className={`${step===5 ? "block" : "hidden"} mt-4 h-[400px]  `} >
            ...
            <div className="pt-[30px]" >
                <h1 className='text-[20px] font-[600]'>What additional equipment or services do you need?</h1>
                <div className='mt-[20px] flex'>
                <div className=' w-full flex  '>
                <FormControl className=' w-full'>
  
                <FormGroup>
      <FormControlLabel value="MC" control={<Checkbox />} label="MC" />
      <FormControlLabel value="Microphones" control={<Checkbox />} label="Microphones" />
      <FormControlLabel value="Dance Floor Lighting" control={<Checkbox />} label="Dance Floor Lighting" />
      <FormControlLabel value="Room Lighting" control={<Checkbox />} label="Room Lighting" />
      <FormControlLabel value="Photo Booth" control={<Checkbox />} label="Photo Booth" />
      <FormControlLabel value="not sure" control={<Checkbox />} label="I'm not sure, send me options" />
         ...
         <div className={`${step===6 ? "block" : "hidden"} mt-4 h-[400px]  `} >
            ...
            <div className="pt-[50px]" >
                <h1 className='text-[20px] font-[600]'>What events will you need services for?</h1>
                <div className='mt-[20px] flex'>
                <div className=' w-full flex  '>
                <FormControl className=' w-full'>
      ...
      <FormControlLabel value="Cocktail Hour" control={<Checkbox />} label="Cocktail Hour" />
      <FormControlLabel value="Dinner" control={<Checkbox />} label="Dinner" />
      <FormControlLabel value="Reception" control={<Checkbox />} label="Reception" />
         ...
         <div className={`${step===7 ? "block" : "hidden"} mt-4 h-[400px]  `} >
            ...
            <div className="pt-[50px]">
                <h1 className='text-[20px] font-[600]'>When and how long is your event?</h1>
                <div className='mt-[50px] flex'>
                <div className='border-[1px] border-slate-300 w-[230px] flex justify-center  '>
                <input type="text" className="  placeholder:text-center placeholder:text-[14px] h-[50px] outline-none  "
         ...
         <div className={`${step===8 ? "block" : "hidden"} mt-4 h-[400px]  `} >
            ...
            <div  >
                <h1 className='text-[20px] font-[600]'>What's your estimated budget for music services?</h1>
                <div className='mt-[20px] flex'>
                <div className=' w-full flex  '>
                <FormControl className=' w-full'>
  ...
  >
    ...
    <FormControlLabel value="$2,000 - $4000" control={<Radio />} label="$2,000 - $4000" />
    <FormControlLabel value="$4,000 - $6,000" control={<Radio />} label="$4,000 - $6,000" />
    <FormControlLabel value="$6,000 - $8,000" control={<Radio />} label="$6,000 - $8,000" />
    <FormControlLabel value="Over $8,000" control={<Radio />} label="Over $8,000" />
  ...
  >
    ...
    <FormControlLabel value="Maybe" control={<Radio />} label="Maybe later"/>
         ...
         <div className={`${step===10 ? "block" : "hidden"} mt-4 h-[400px]  `} >
         ...
         <div className={`bg-green-500 w-[100px] h-[40px] text-white font-[500]
            ...
            <div className={`bg-red-500 w-[100px] h-[40px] text-white font-[500]
             flex justify-center items-center hover:bg-red-600 cursor-pointer  ${step===10 ? "hidden" : ""}`}
             ...
             flex justify-center items-center hover:bg-red-600 cursor-pointer  ${step===10 ? "block" : "hidden"}`}
             type="submit">
                    Submit
                </button>
         </div>
