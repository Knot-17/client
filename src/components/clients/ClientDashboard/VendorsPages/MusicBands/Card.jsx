          ...
          <div className="h-[600px] w-full md:w-[600px] bg-white rounded-[5px] flex justify-center">
            ...
            ${
                      ...
                      <FormControl className=" w-full">
                        <FormGroup>
                          ...
                          <FormControlLabel
                            value="not sure"
                            control={<Checkbox />}
                            label="I'm not sure, send me options"
                          />
                        </FormGroup>
                      </FormControl>
                    </div>
              ...
              >
                <div className="pt-[50px]">
                  <h1 className="text-[20px] font-[600]">
                    What events will you need services for?
                  </h1>
                  <div className="mt-[20px] flex">
                    <div className=" w-full flex  ">
                      <FormControl className=" w-full">
              ...
              >
                <div className="pt-[50px]">
                  <h1 className="text-[20px] font-[600]">
                    When and how long is your event?
                  </h1>
                  <div className="mt-[50px] flex">
                    <div className="border-[1px] border-slate-300 w-[230px] flex justify-center  ">
                      <input
              ...
              >
                <div>
                  <h1 className="text-[20px] font-[600]">
                    What's your estimated budget for music services?
                  </h1>
                  <div className="mt-[20px] flex">
                    <div className=" w-full flex  ">
                      <FormControl className=" w-full">
