...
const Cardss = ( {AvailableArea,VendorPic}) => {
        ...
        <div className='w-full'>
          ...
          <div className={`fixed pt-[100px] z-[1] left-0 top-0 overflow-auto w-full h-full
           bg-black/40  justify-center items-center ${showReqQuote===true? 'flex': 'hidden'}`}>
            ...
            <h1 className=' text-[12px] font-[500]'>{step +1} of 9 - {DisplaySteps()}</h1>
            <div className=' w-full  h-[8px] rounded '>
            {/*progress bar */}
            
            <div  className={` h-[100%] bg-green-700 rounded
            ${step === 0 ? "w-[11%]" : step === 1 ? "w-[22%]" : step === 2 ? "w-[33%]" : step === 3 ? "w-[44%]" :
             step === 4 ? "w-[55%]" : step === 5 ? "w-[66%]" : step === 6? "w-[77%]" : step === 7? "w-[88%]" : step === 8? "w-[100%]"   : ""}
            } `}>
            </div>
          </div>
    ...
    <option value="301 or more">301 or more</option>
         ...
         <div className={`${step===4 ? "block" : "hidden"} mt-4 h-[400px]  `} >
            ...
            <div className="pt-[30px]" >
                <h1 className='text-[20px] font-[600]'>Which events do you plan to hold at this venue?</h1>
                <div className='mt-[20px] flex'>
                <div className=' w-full flex  '>
                <FormControl className=' w-full'>
  
                <FormGroup>
      <FormControlLabel value='Rehearsal' control={<Checkbox />} label="Rehearsal" />
      <FormControlLabel value='Ceremony' control={<Checkbox />} label="Ceremony" />
      <FormControlLabel value='Reception' control={<Checkbox />} label="Reception" />
         ...
         <div className={`${step===5 ? "block" : "hidden"} mt-4 h-[400px]  `} >
            ...
            <div className="pt-[30px]" >
                <h1 className='text-[20px] font-[600]'>What additional services might you be interested in?</h1>
                <div className='mt-[20px] flex h-[300px] overflow-auto'>
                <div className=' w-full flex  '>
                <FormControl className=' w-full'>
  
                <FormGroup>
      <FormControlLabel value='Indoor area' control={<Checkbox />} label="Indoor area" />
      <FormControlLabel value='Outdoor area' control={<Checkbox />} label="Outdoor area" />
      <FormControlLabel value='Sound equipment' control={<Checkbox />} label="Sound equipment" />
      <FormControlLabel value='Video equipment' control={<Checkbox />} label="Video equipment" />
      <FormControlLabel value='Tables & chairs' control={<Checkbox />} label="Tables & chairs" />
      <FormControlLabel value='Linens' control={<Checkbox />} label="Linens" />
      <FormControlLabel value='Lighting' control={<Checkbox />} label="Lighting" />
      <FormControlLabel value='Kitchen/Bar area' control={<Checkbox />} label="Kitchen/Bar area" />
      <FormControlLabel value='On-site catering' control={<Checkbox />} label="On-site catering" />
      <FormControlLabel value='Party planning services' control={<Checkbox />} label="Party planning services" />
         ...
         <div className={`${step===6 ? "block" : "hidden"} mt-4 h-[400px]  `} >
            ...
            <div  >
                <h1 className='text-[20px] font-[600]'>What's your estimated budget for venue services?</h1>
  ...
  >
    <FormControlLabel value="Over $65,000" control={<Radio />} label="Over $65,000"/>        
    <FormControlLabel value="$55,000 - $65,000" control={<Radio />} label="$55,000 - $65,000" />
    <FormControlLabel value="$45,000 - $55,000" control={<Radio />} label="$45,000 - $55,000" />
    <FormControlLabel value="$35,000 - $45,000" control={<Radio />} label="$35,000 - $45,000" />
    <FormControlLabel value="$35,000 - $45,000" control={<Radio />} label="$35,000 - $45,000" />
    <FormControlLabel value="$15,000 - $25,000" control={<Radio />} label="$15,000 - $25,000" />
    <FormControlLabel value="$5,000 - $15,000" control={<Radio />} label="$5,000 - $15,000" />
    <FormControlLabel value="Less than $5,000" control={<Radio />} label="Less than $5,000" />
    ...
    <FormControlLabel value="Maybe" control={<Radio />} label="Maybe later"/>
         ...
         <div className={`bg-green-500 w-[100px] h-[40px] text-white font-[500]
            ...
            <div className={`bg-red-500 w-[100px] h-[40px] text-white font-[500]
             flex justify-center items-center hover:bg-red-600 cursor-pointer  ${step===8? "hidden" : ""}`}
...
=======
             ...
             flex justify-center items-center hover:bg-red-600 cursor-pointer  ${step===8 ? "block" : "hidden"}`}
             type="submit">
                    Submit
>>>>>>> 3bb25946de5a1ac1072466c422b0e2011f8e57ed
                </button>
         </div>
         </form>
