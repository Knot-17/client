  ...
  return (
    <div>
      ...
      <div className="flex">
        ...
        <DropdownContainer
          className={`${showGuestCapacity ? "block" : "hidden"} ml-[16.5%] `}
          ref={GCDropRef}
        >
          <GuestCapacityForm>
            <FormControl>
          ...
          <FormGroup className="ml-[30px]  h-[500px]">
            <div className="overflow-auto ">
              ...
              <div className="flex  ">
                ...
                />
                <FormControlLabel
                  value="Vineyard & Winery"
                  control={<Checkbox />}
                  label="Vineyard & Winery"
                />
              </div>

              <MoreFiltersH1 className="mt-[60px]">
                Venue Amenities
              </MoreFiltersH1>
              ...
              <div className="flex  ">
                ...
                <FormControlLabel
                  ...
                  control={<Checkbox />}
                  label="On-Site Accommodations"
                />
              </div>
              <div className="flex  ">
                <FormControlLabel
                  value="Handicap Accessibl"
                  className="w-[190px]"
                  control={<Checkbox />}
                  label="Handicap Accessibl"
                />
                <FormControlLabel
              ...
              <div className="flex  ">
                <FormControlLabel
                  value="Indoor Event Space"
                  className="w-[190px]"
                  control={<Checkbox />}
                  label="Indoor Event Space"
                />
                <FormControlLabel
              ...
              <div className="flex  ">
                <FormControlLabel
                  value="Cakes & Desserts"
                  className="w-[190px]"
                  control={<Checkbox />}
                  label="Cakes & Desserts"
                />
                <FormControlLabel
                  value="Rentals & Equipment"
                  control={<Checkbox />}
