          ...
          <div className="h-[600px] w-full md:w-[600px] bg-white rounded-[5px] flex justify-center">
            ...
            ${
              ...
              >
                <div className="pt-[50px]">
                  <h1 className="text-[20px] font-[600]">
                    When and how long do you need wedding photography?
                  </h1>
                  <div className="mt-[50px] ">
                    <div className="mt-[50px] flex">
                      <div className="border-[1px] border-slate-300 w-[230px] flex justify-center  ">
                    ...
                    <div className="text-[20px]">
                      <FormGroup>
                        <FormControlLabel
                          ...
                          control={<Checkbox />}
                          label="Second Photographer (another photographer to provide additional coverage on your big day)"
                        />
                        <FormControlLabel
                          value="Nondigital Products"
                          className="mt-[20px]"
                          control={<Checkbox />}
                          label="Nondigital Products (wedding album, parent's album, heirloom boxes, prints, etc.)"
                        />
                        <FormControlLabel
