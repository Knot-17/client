...
export const BeauServicesContainer = styled.div`
...
`
export const FitnessServicesContainer = styled.div`
...
`
export const FitnessServicesForm= styled.form `
    
    width: 100%;
   

`
export const BeutyServicesForm= styled.form `
